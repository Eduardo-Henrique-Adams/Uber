...
class _CorridaState extends State<Corrida> {
  ...
  get UsuarioFirebase => null;

  _alterarBotaoPrincipal(String texto, Color cor, Function funcao) {
    setState(() {
      _textoBotao = texto;
      _corBotao = cor;
      _funcaoBotao = funcao as void Function();
    });
  }
  ...
  _recuperarRequisicao() async {
    ...
    String? idRequisicao = widget.idRequisicao as String?;
  ...
  void initState() {
    ...
    _idRequisicao = widget.idRequisicao as String;
